...
public abstract class BaseShoppingManagerTest {
	...
	public void createBoots() {
		...
		bestShoes.add(new Boots(38, 2059.0, "winter", Sex.FEMALE, "ECCO", "black", "skin", "fur", lowPump, "oval", 35.5));
		bestShoes.add(new Boots(41, 1300.0, "winter", Sex.FEMALE, "CCC", "blue", "textile", "textile", thickenedSole,
				"square", 24.6));
		bestShoes.add(new Boots(39, 2059.0, "winter", Sex.FEMALE, "Welfare", "brown", "leatherette", "fur", highPump,
				"sharpToecap", 34.0));
		...
		bestShoes.add(new Pumps(40, 1600.0, "classical", Sex.FEMALE, "ECCO", "black", "skin", "skin", highPump,
				"sharpToecap", DegreeOfOpenness.OPEN_SIDE));
		bestShoes.add(new Sneakers(43, 1800.0, "sport", Sex.MALE, "Nike", "blue", "textile", "orthoLite", thickenedSole,
